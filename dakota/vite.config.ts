...
//   4790 — Vite SPA (this config)
//   4791 — Nitro API (proxied under /api)
export default defineConfig({
  ...
  server: {
    host: '127.0.0.1',
    // Durable project port is 4790 (PM2 + Tailscale funnel). Preview/secondary
